												...
												<table>
													<tbody>
														<tr>
															<td>
																<div class="ls-slide-link">
																	<?php lsGetInput($lsDefaults['layers']['linkURL'], $layerProps, array('placeholder' => $lsDefaults['layers']['linkURL']['name'] )) ?>
																	<br> <?php lsGetSelect($lsDefaults['layers']['linkTarget'], $layerProps) ?>
																	<span> or <a href="#"><?php _e('use post URL', 'LayerSlider') ?></a></span>
																</div>
															</td>
														</tr>
