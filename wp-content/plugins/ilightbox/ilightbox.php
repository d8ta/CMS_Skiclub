...
class iLightBox {
	...
	*/
	...
	function init() {
		...
		if ( is_admin() ) {
			...
			add_action('init', array($this, 'ilightbox_register_scripts_frontend'));
	...
	*/
	...
	function ilightbox_register_scripts_frontend(){
	...
	function ilightbox_menu_style() {
		...
		<style type="text/css" media="screen">
			#toplevel_page_ilightbox_general .wp-menu-image {
				background: url(<?php echo $this->ILIGHTBOX_URL; ?>css/images/menu_icon.png) no-repeat 5px 2px !important;
				opacity: .7;
