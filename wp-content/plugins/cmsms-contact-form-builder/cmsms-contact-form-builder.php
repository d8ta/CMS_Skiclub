...
class Cmsms_Form_Builder {
	...
	function form_builder_admin_scripts() {
		wp_register_style('cmsms_form_builder_css', CMSMS_FORM_BUILDER_URL . 'css/cmsms-contact-form-builder.css', array(), '1.2.0', 'screen');
		
		wp_register_style('cmsms_form_builder_css_rtl', CMSMS_FORM_BUILDER_URL . 'css/cmsms-contact-form-builder-rtl.css', array(), '1.2.0', 'screen');
		
		
		wp_register_script('cmsms_form_builder_js', CMSMS_FORM_BUILDER_URL . 'js/cmsms-contact-form-builder.js', array('jquery', 'jquery-ui-sortable'), '1.2.0', true);
	...
	function form_builder_scripts() {
		if (!is_admin()) {
			...
			wp_register_script('validatorLanguage', CMSMS_FORM_BUILDER_URL . 'js/jquery.validationEngine-lang.js', array('jquery', 'validator'), '1.0.0', true);
